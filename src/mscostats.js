...
if(!statsdone && Game.sortedMods.length==0)
{
	...
	eval('Game.computeLumpType='+Game.computeLumpType.toString().replace("Math.seedrandom();", "Math.seedrandom(); if (Game.lumpCurrentType==1) { document.addEventListener(\"keydown\", my_onkeydown_handler);}"));
